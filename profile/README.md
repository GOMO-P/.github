...
<div align="center">
  <img src="https://github.com/GOMO-P/Mirae/blob/main/assets/images/mirae-banner.png?raw=true" width="100%" />
</div>
...
* **주요 특징:**
    * **그룹 채팅:** Firebase Firestore 기반의 그룹의 실시간 메시징
    * **개인 채팅:** Firebase Firestore 기반의 개인간 실시간 메시징
...
* **주요 특징:**
    ...
    * **팔로우/팔로잉:** 관심 있는 유저와 친구 맺기 및 개인 채팅으로 연결<br>
